    ...
    return SafeArea(
      child: LayoutBuilder(
        builder: (context, constraints) {
          return Stack(
            children: [
              // Scrollable content (without the buttons)
              SingleChildScrollView(
                padding: const EdgeInsets.fromLTRB(16, 16, 16, 148), // leave room for fixed buttons
                child: ConstrainedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 24),
                      // (Buttons removed from here; now fixed at bottom)
                    ],
                  ),
                ),
              ),
