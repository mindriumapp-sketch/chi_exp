...
class _CognitiveLoadSurveyScreenState extends State<CognitiveLoadSurveyScreen> {
  ...
  final List<String> _cogQuestions = const [
    "1. '상황', '생각', '결과'에 따라 감정을 기록하는 것이 어려웠다.",
    "2. 감정일기 작성을 위해 '상황-생각-결과'를 떠올리는 과정이 매우 복잡하게 느껴진다.",
    "3. '상황’과 ‘생각’, ‘생각’과 ‘결과’의 관계를 명확하게 구분하는 것이 어려웠다.",
    ...
    "10. 일기 작성을 통해 상황-생각-결과 간의 상관관계를 더 잘 이해하게 되었다.",
  ];
